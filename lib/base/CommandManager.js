...
const HashiSlashCommand_1 = require("../root/HashiSlashCommand");
const CoolDownManager_1 = require("../root/CoolDownManager");
const InterferingManager_1 = require("../root/InterferingManager");
...
class CommandManager extends Base_1.Base {
     ...
     */
    #interfering = new InterferingManager_1.InterferingManager();
    /**
