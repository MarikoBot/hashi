...
class CommandManager extends Base_1.Base {
     ...
     */
    async loadCommands() {
        const commandFiles = this.client.fileManager.read(`${FileManager_1.FileManager.ABSPATH}${this.client.commandsDir}`, `${FileManager_1.FileManager.RMPATH}${this.client.commandsDir}`, {
