...
class DatabaseManager extends Base_1.Base {
     ...
     */
    loadDataMaps() {
        const definitions = this.client.fileManager.read(`${FileManager_1.FileManager.ABSPATH}${this.client.dataMapsDir}`, `${FileManager_1.FileManager.RMPATH}${this.client.dataMapsDir}`, {
            absPathStrSelf: `./lib/${this.client.dataMapsDir}`,
            rmPathStrSelf: `../${this.client.dataMapsDir}`,
        });
        const models = this.client.fileManager.read(`${FileManager_1.FileManager.ABSPATH}${this.client.dataMapsDir}/../models`, `${FileManager_1.FileManager.RMPATH}${this.client.dataMapsDir}/../models`, {
