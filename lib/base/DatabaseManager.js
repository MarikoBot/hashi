 ...
 */
class DatabaseManager extends _1.Base {
    /**
     ...
     */
    loadDataMaps() {
        const definitions = this.client.fileManager.read(`${root_1.FileManager.ABSPATH}${this.client.dataMapsDir}`, `${root_1.FileManager.RMPATH}${this.client.dataMapsDir}`, {
            absPathStrSelf: `./lib/${this.client.dataMapsDir}`,
            rmPathStrSelf: `../${this.client.dataMapsDir}`,
        });
        const models = this.client.fileManager.read(`${root_1.FileManager.ABSPATH}${this.client.dataMapsDir}/../models`, `${root_1.FileManager.RMPATH}${this.client.dataMapsDir}/../models`, {
...
__decorate([
    decorators_1.Validators.ObjectValidator.KeyDataMapPair
