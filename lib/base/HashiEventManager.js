...
exports.HashiEventManager = void 0;
 ...
 */
class HashiEventManager extends _1.BaseClient {
    /**
    ...
    HashiEventInjector(name) {
        ...
        return function (target) {
            ...
            this.client.src[name === 'ready' ? 'once' : 'on'](name, (...args) => new target().callback(this.client, ...args));
        };
    }
}
exports.HashiEventManager = HashiEventManager;
__decorate([
...
], HashiEventManager.prototype, "eventsList", void 0);
