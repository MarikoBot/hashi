...
exports.ObjectValidator = {
     ...
     */
    CommandGroupValueInitial: (hashiMessageCommand, hashiSlashCommand, hashiSlashSubcommand, hashiSlashSubcommandGroup) => {
        return function (target, key) {
            ...
            const setter = (newValue) => {
                if (typeof newValue !== 'object' ||
                    ...
                    throw new Error(`The property ${target.constructor.name}.${key} must be an instance of one of the CommandGroupValue initial type classes.`);
                value = newValue;
            };
