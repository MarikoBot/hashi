    ...
    ValidId: (target, key) => {
        ...
        const setter = (newValue) => {
            if (typeof newValue !== 'string' ||
                newValue.match(exports.StringValidatorRegExp.validIdRegExp).join('') !== newValue)
    ...
    ValidPrimaryKeys: (target, key) => {
        ...
        const setter = (newValue) => {
            if (typeof newValue !== 'string' ||
                ...
                throw new Error(`The property ${target.constructor.name}.${key} must be a valid primary keys ` +
                    `string (${exports.StringValidator.validPrimaryKeysRegExp.toString()}).`);
            value = newValue;
        };
        Object.defineProperty(target, key, {
            get: () => value,
    ...
    ValidVersion: (target, key) => {
        ...
        const setter = (newValue) => {
            if (typeof newValue !== 'string' ||
                ...
                throw new Error(`The property ${target.constructor.name}.${key} must be a valid version ` +
                    `string (${exports.StringValidator.validVersionRegExp.toString()}).`);
            value = newValue;
        };
        Object.defineProperty(target, key, {
            get: () => value,
