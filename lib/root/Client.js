...
class Client {
    ...
    constructor(options) {
        ...
        process.on('unhandledRejection', (reason) => new base_1.Logger(this).error(reason?.stack || reason));
        process.on('uncaughtException', (err, origin) => {
            new base_1.Logger(this).error(err);
            new base_1.Logger(this).error(origin);
