...
class Client {
    ...
    constructor(options) {
        ...
        this.logger = new base_1.Logger(this);
        ...
        process.on('unhandledRejection', (reason) => new base_1.Logger(this).log('error', reason?.stack || reason));
        process.on('uncaughtException', (err, origin) => {
            new base_1.Logger(this).log('error', err);
            new base_1.Logger(this).log('error', origin);
