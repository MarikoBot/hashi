...
class SuperModel {
     ...
     */
    constructor(name, tableStructure) {
        this.name = name;
        this.columns = tableStructure;
     ...
     */
    async findOne(...queryParameters) {
        return (await this.model.findOne(...queryParameters).exec());
    }
}
exports.SuperModel = SuperModel;
__decorate([
    decorators_1.ObjectDeepValidator.KeySuperModelColumnPair(_1.SuperModelColumn),
    __metadata("design:type", Object)
], SuperModel.prototype, "columns", void 0);
__decorate([
    decorators_1.ObjectDeepValidator.KindOfInstance(mongoose_1.Model, _1.Placeholder),
    __metadata("design:type", mongoose_1.Model)
], SuperModel.prototype, "model", void 0);
__decorate([
    decorators_1.ObjectDeepValidator.KindOfInstance(mongoose_1.Schema, _1.Placeholder),
