...
class HashiClient {
     ...
     */
    commandManager = new base_1.HashiCommandManager(this);
    /**
     * The event manager instance.
     */
    eventManager = new base_1.HashiEventManager(this);
    /**
    ...
    async login(token = process.env.TOKEN || process.env.token || process.env.Token) {
        ...
        void (await this.src.application.commands.set(this.commandManager.discordCommandsData));
        let i = -1;
        let dataMap;
